...
contract Investment {
    ...
    function _addInvestor(
        ...
        uint256 time_lock = _createEscrow(_days);
    ...
    function _createEscrow(uint256 _days) internal view returns (uint256) {
    ...
    Pausable
{
    ...
    function burnAutoLP() external onlydeadBurn {
