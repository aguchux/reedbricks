...
contract Ownable {
    ...
    function unlock() public {
        require(
            ...
            "You don not have permission to unlock"
        );
    ...
    Ownable
{
    ...
    uint256 private immutable _burncap;
    uint private _burnBurst;
    ...
    constructor(
        ...
        _mintcap = _totalSupply;
        _burncap = 10 * 10**6 * 10**18;
        _burnBurst = 1 * 10**5 *10**18;
        _burnCount = 0;
    ...
    function blacklistAddress(address account, bool value) external onlyOwner protectOwner {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        if (_isExcluded[sender] || _isExcluded[recipient]) {
            ...
            _balances[sender] = _balances[sender].sub(newAmount);
