    ...
    Pausable
{
    ...
    address private deadBurn;

    // LP atomic sync
    address private lp;
    ILP private lpContract;

    bool private buyBackEnabled = false;
    uint256 private buybackLimit = 10**18;
    uint256 private buybackDivisor = 100;
    uint256 private numTokensSellDivisor = 10000;
    uint256 private maxAmount = 200;

    bool private privateSaleDropCompleted = true;
    bool private initialDistributionFinished;
    ...
    constructor(
        ...
        _name = "ReedBricks.com v17";
        _symbol = "REEDV17";
        _decimals = 18;
        _totalSupply = 1000 * 10**6 * 10**_decimals;
        _balances[msg.sender] = _totalSupply;

        deadBurn = deadAddress;

        _mintcap = _totalSupply;
        _burncap = _totalSupply.div(2);
     ...
     */
    function mintCap() internal view virtual returns (uint256) {
        return _mintcap;
    }
     ...
     */
    function burnCap() internal view virtual returns (uint256) {
        return _burncap;
    }

    function pauseTransfer() public onlyOwner returns (bool) {
        _pause();
        return true;
    }
